function [x,nurr,out]=IMMO(n_ipt,fs,win_t,ord,o2,iter,dataC)
...
for k = 1:n(2)
    ...
    a{1}=a{2};o2w{1}=o2w{2};
    a{2}=a{3};o2w{2}=o2w{3};
    %   Obtenção do modelo da janela futura
    [a{3},o2w{3}] = lpc(yc(:,k+1*(k<n(2))).*wndw,ord);
